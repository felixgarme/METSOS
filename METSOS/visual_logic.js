...
function zoneA() {
  ...
  registerSetTimeout(1, function() {
    ModoP1();
    tweenCamera('A1', 'pCube13', 0.8, function() {}, 0);
    registerSetTimeout(1, function() {
...
function zoneB() {
  ...
  handleAnnot(true, 'Planta de H2SO4', 'ZoneB', '', 'zoneB', undefined);
  registerSetTimeout(1, function() {
...
function zoneC() {
  ...
  registerSetTimeout(1, function() {
    ...
    registerSetTimeout(1, function() {
      ...
      Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('if (typeof window.toggleBotonesVC === \'function\') {' + '\n' +
      '    window.toggleBotonesVC(true);' + '\n' +
      '}')))(appInstance, v3d, PL, VARS, PROC);
