...
function vA2() {
  ...
  registerSetTimeout(1, function() {
    tweenCamera('A2', 'polySurface1105', 2, function() {}, 0);
...
function vA4() {
  ...
  registerSetTimeout(1, function() {
    tweenCamera('A4', 'polySurface1145', 3, function() {}, 0);
...
function vB1() {
  disable();
  tweenCamera('', 'B1', 0.5, function() {}, 0);
  registerSetTimeout(0.6, function() {
    tweenCamera('B1', 'pCube133.003', 0.5, function() {}, 0);
...
function vB3() {
  disable();
  tweenCamera('', 'B3', 0.5, function() {}, 0);
  registerSetTimeout(0.6, function() {
    tweenCamera('B3', 'pCube133.001', 0.5, function() {}, 0);
...
function vB4() {
  disable();
  tweenCamera('', 'B4', 0.5, function() {}, 0);
  registerSetTimeout(0.6, function() {
    tweenCamera('B4', 'pCube133.007', 0.5, function() {}, 0);
...
function vB5() {
  disable();
  tweenCamera('', 'B5', 0.5, function() {}, 0);
  registerSetTimeout(0.6, function() {
    tweenCamera('B5', 'pCube133.005', 0.5, function() {}, 0);
    outline('pCube133.001', 'ENABLE');
  });
}
...
// Describe this function...
function vB6() {
  VB6_obj = 'pCube133.006';
  tweenCamera('', 'B6.001', 0.5, function() {}, 0);
  registerSetTimeout(0.7, function() {
    tweenCamera('B6.001', 'B6.002', 0.5, function() {
      tweenCamera('', 'B6.002', 0.5, function() {}, 0);
      registerSetTimeout(0.7, function() {
        tweenCamera('B6.002', 'B6', 0.5, function() {
          tweenCamera('', 'B6', 0.5, function() {}, 0);
          registerSetTimeout(0.7, function() {
            tweenCamera('B6', VB6_obj, 0.5, function() {}, 0);
...
function vB7() {
  ...
  registerSetTimeout(0.2, function() {
    ...
    registerSetTimeout(1.2, function() {
      tweenCamera('', 'B7.1', 0.5, function() {}, 0);
      outline('pCube133.004', 'ENABLE');
      registerSetTimeout(0.6, function() {
        tweenCamera('B7.1', 'B7', 0.5, function() {
          tweenCamera('B7', 'pCube133.004', 0.5, function() {}, 0);
        }, 0);
      });
    });
  });
...
function vB8() {
  ...
  registerSetTimeout(0.2, function() {
    ...
    registerSetTimeout(1.2, function() {
      ...
      tweenCamera('', 'B8', 0.5, function() {}, 0);
      registerSetTimeout(0.6, function() {
        tweenCamera('B8', 'pCube133.002', 0.5, function() {}, 0);
      });
    });
  });
}
...
function continuarC() {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'textocentro("Estaciones de Lavaojos y duchas de emergencia", { size: "large", duration: 2500 });')(appInstance, v3d, PL, VARS, PROC);
...
function vC1() {
  outline(['ALL_OBJECTS'], 'DISABLE');
  tweenCamera('C1', 'pCube205', 1, function() {}, 0);
  registerSetTimeout(1.1, function() {

    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('crearOndas3d("pCube205", {' + '\n' +
    '  radioInicial: 2,' + '\n' +
    '  radioFinal: 20,' + '\n' +
    '  duracion: 6,' + '\n' +
    '  numOndas: 4' + '\n' +
...
function vC2() {
  ...
  registerSetTimeout(1, function() {
    ...
    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('crearOndas3d("pCube211", {' + '\n' +
    '  radioInicial: 2,' + '\n' +
    '  radioFinal: 20,' + '\n' +
    '  duracion: 6,' + '\n' +
    '  numOndas: 4' + '\n' +
    ...
    registerSetTimeout(1.1, function() {
      tweenCamera('C2', 'pCube210', 1, function() {}, 0);
    });
  });
}
...
function vC3() {
  ...
  registerSetTimeout(1, function() {
    ...
    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('crearOndas3d("pCube208", {' + '\n' +
    '  radioInicial: 2,' + '\n' +
    '  radioFinal: 20,' + '\n' +
    '  duracion: 6,' + '\n' +
    '  numOndas: 4' + '\n' +
    ...
    registerSetTimeout(1.1, function() {
      tweenCamera('C3', 'pCube209', 1, function() {}, 0);
    });
  });
}
...
function vC4() {
  ...
  registerSetTimeout(1, function() {
    ...
    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('crearOndas3d("pCube206", {' + '\n' +
    '  radioInicial: 2,' + '\n' +
    '  radioFinal: 20,' + '\n' +
    '  duracion: 6,' + '\n' +
    '  numOndas: 4' + '\n' +
    ...
    registerSetTimeout(1.1, function() {
      tweenCamera('C4', 'pCube207', 1, function() {}, 0);
    });
  });
}
